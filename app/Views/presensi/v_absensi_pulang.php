...
<div class= "row" style= "margin-top: 70px; ">
    <div class= "col">
        ...
        <button id="TakeAbsen" class= "btn btn-primary btn-block"><i class="fas fa-camera mr-1"></i>Absen Pulang</button>
        <input type="hidden" name="lokasi" id="lokasi">
        <div id="map" style="width:100%; height: 400px;"></div>
        <audio id="notifikasi_in">
            <source src="<?= base_url('suara/sound_out.mp3') ?>" type="audio/mpeg">
        </audio>
    </div>
</div>
